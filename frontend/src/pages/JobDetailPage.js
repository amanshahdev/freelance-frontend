...
export default function JobDetailPage() {
  ...
  const handleApply = async (e) => {
    ...
    if (
      ...
      !applyForm.proposedRate ||
      !applyForm.estimatedDays
    ) {
        ...
        >
          ...
          <div>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                <span
                  className={`badge ${STATUS_BADGE[job.status] || "badge-muted"}`}
                >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 16 }}>
                ...
                {job.deadline && (
                  <MetaItem
                    icon={<FiClock size={14} />}
                    text={`Deadline: ${format(new Date(job.deadline), "MMM d, yyyy")}`}
                  />
                )}
              </div>
            </div>
                  ...
                  <div className="form-group">
                    ...
                    <span
                      style={{
                        fontSize: 12,
                        color:
                          applyForm.coverLetter.length < 50
                            ? "var(--text-muted)"
                            : "var(--success)",
                      }}
                    >
                  ...
                  <div style={{ display: "flex", gap: 10 }}>
                    ...
                    >
                      {applying ? (
                        ...
                        <>
                          <FiCheck size={15} /> Submit Proposal
                        </>
                      )}
                    </button>
                    <button
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              {isFreelancer && (hasApplied || showApply) && (
                ...
                >
                  <FiCheck size={16} />{" "}
                  {hasApplied ? "Application Submitted" : "Applying…"}
                </div>
              )}
              {isOwner && (
                <div
